<template>
    <AppLayout title="Kategorie dokumentů">
        <div class="p-6 space-y-4">
            <PageHeader
                title="Kategorie dokumentů"
                new-btn-title="Přidat kategorii"
                new-btn-acl="documents.categories.edit"
                ...
                >
                    ...
                    <template #default="{ node }">
                        ...
                        <Button
                            ...
                            v-if="$userCan('documents.categories.edit')"
...
import DocumentCategoryForm from "@/Components/DocumentCategory/DocumentCategoryForm.vue";
...
function confirmDelete(model) {
    confirm.require({
        ...
        accept: () => {
            router.delete(route('documents.categories.destroy', model.id), {
                preserveState: true
            })
        },
    })
